# Generated by Django 4.1.1 on 2022-11-02 16:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('flight_management', '0008_alter_flight_nm_destination_alter_flight_nm_origin'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='nm_status',
            field=models.IntegerField(choices=[(0, 'Previsto'), (1, 'Cancelado'), (2, 'Embarcando'), (3, 'Programado'), (4, 'Taxiando Ida'), (5, 'Pronto'), (6, 'Autorizado'), (7, 'Em Voo'), (8, 'Aterrissado'), (9, 'Desembarcando')], default=0),
        ),
    ]
